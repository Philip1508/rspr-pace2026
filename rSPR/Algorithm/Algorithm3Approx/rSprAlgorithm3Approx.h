...
namespace rSpr3Approx {

	/*
	__attribute__((always_inline)) inline int rSPR_worse_3_approx_binary_hlpr_Inline(
	bool &APPROX_CHECK_COMPONENT,

	Forest *T1, Forest *T2, list<Node *> *singletons, list<Node *> *sibling_pairs, Forest **F1, Forest **F2, bool save_forests) {
	#ifdef DEBUG_APPROX
...
return num_cut;
	...
	__attribute__((always_inline)) inline void reduction_leaf_Inline(Forest *T1, Forest *T2, UndoMachine *um) {
